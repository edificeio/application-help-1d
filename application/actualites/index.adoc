...
image:/assets/Actu 2.png[alt=""]
image:/assets/Actu 3.png[alt=""]
image:/assets/Actu 4.png[alt=""]
...
image:/assets/Actu 6.png[alt=""]

Les différents droits que vous pouvez attribuer aux autres utilisateurs
de la plateforme sur le fil d'actualités sont les suivants :
...
Les différents droits que vous pouvez attribuer aux autres utilisateurs
de la plateforme sur l'actualité sont les suivants :
